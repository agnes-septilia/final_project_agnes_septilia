...
with DAG(
    ...
    schedule_interval = '0 17 L * *',   # set to match timezone utc +7 00:00, set to every end-of-month
    ...
    create_fact_monthly_avg_currency = PostgresOperator(
        ...
        sql = open("/home/agnes/Documents/digital_skola/Project/final_project/fact_table/fact_monthly_avg_currency.sql").read()
    )
