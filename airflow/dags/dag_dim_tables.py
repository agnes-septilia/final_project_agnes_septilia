...
with DAG(
    ...
    create_dim_country = PostgresOperator(
        ...
        sql = open("/home/agnes/Documents/digital_skola/Project/final_project/dimension_table/dim_country.sql").read()
    )
    ...
    create_dim_state = PostgresOperator(
        ...
        postgres_conn_id = "airflow_final_project",
        sql = open("/home/agnes/Documents/digital_skola/Project/final_project/dimension_table/dim_state.sql").read()
    )
    ...
    create_dim_city = PostgresOperator(
        ...
        postgres_conn_id = "airflow_final_project",
        sql = open("/home/agnes/Documents/digital_skola/Project/final_project/dimension_table/dim_city.sql").read()
    )
    ...
    create_dim_currency = PostgresOperator(
        ...
        postgres_conn_id = "airflow_final_project",
        sql = open("/home/agnes/Documents/digital_skola/Project/final_project/dimension_table/dim_currency.sql").read()
    ) 
